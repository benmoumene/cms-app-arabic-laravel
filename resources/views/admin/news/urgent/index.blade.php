                        ...
                        <div class="panel-heading text-right h4">عرض كل الاخبار</div>
                            <table class="table" id="myList" >
                                ...
                                <tr class="text-center" id="new-{{$new->id}}">
                                    ...
                                    <form>
                                        <a href="{{route('admin.news_urgent.edit',$new->id)}}" class="btn btn-warning edit" title="edit"><i class="glyphicon glyphicon-pencil"></i></a>
...
$(".delete").click(function(e){
            e.preventDefault();
              ...
              $.ajax(
              {
                  url: "/adminPanel/news_urgent/delete/"+id,
                  type: 'DELETE',
                  dataType: "JSON",
                  data: {
                      "id": id,
