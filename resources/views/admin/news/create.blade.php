...
<div class="main_container  main_menu_open">
                ...
                <div class="page_content">
                    ...
                    <div class="form">
                        <form class="form-horizontal" enctype="multipart/form-data" action="{{route('admin.news.store')}}" method="post" >
                                    @csrf                    
                      
                                <div class="form-group">
                                    <label for="ad_title">عنوان اشاري</label>
                                    <input type="text" name="reference_address" class="form-control" id="ad_title" placeholder="اسم او عنوان الاعلان">
                                </div>
                                <div class="form-group">
                                    <label for="ad_title">عنوان الخبر</label>
                                    <input type="text" name="news_address" class="form-control" id="ad_title" placeholder="اسم او عنوان الاعلان">
                                </div>
                                <div class="form-group">
                                    <label for="ad_title">المصدر</label>
                                    <input type="text" name="source" class="form-control" id="ad_title" placeholder="اسم او عنوان الاعلان">
                                </div>
                                
                                <div class="form-group">
                                    <label for="ad_img">* صوره الخبر</label>
                                    <input type="file"  name="image" class="form-control" id="ad_img">
                                </div>
                                <div class="form-group">
                                <label>الاوسمة:</label>
                                <br/>
                            ...
                            <div class="form-group">
                                <label for="exampleFormControlSelect1">الكاتب</label>
                                    ...
                                    <textarea id="edit" name="new_body">Initialize the Froala WYSIWYG HTML Editor on a textarea.</textarea>
                                    </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="link" name="link" class="form-control" id="ad_link" placeholder="EX : http://www.google.com">
                                </div>
                                ...
                                <div class="form-group">
                                <input type="checkbox" name="position[]" value="1"><label>شريط الاخبار (ظهور عنوان الخبر في شريط المتحرك )</label>
                                <br>
                                <input type="checkbox" name="position[]" value="2"><label> خبر رئيسي (في منطقة التميز ) </label>
                                <br>
                                <input type="checkbox" name="position[]" value="3">  <label> الظهور في القالب  </label> 
                                <br>
                                <input type="checkbox" name="position[]" value="4"> <label> خبر مخفي </label> 
                                ...
                                <input type="submit"  class="btn btn-success" name="publish" value="نشر الخبر">                                
                                <input type="submit" class="btn btn-warning" name="save" value="حفظ في مسودة">                                
